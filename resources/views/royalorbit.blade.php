...
@section('content')
    ...
    <!--WELCOME SECTION START-->
        ...
        <div class="section-full small-device  p-tb90">
            <div class="container">
                <div class="row">
                            ...
                            <div class="owl-carousel widget-gallery p-t10 owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="wt-post-thum">
                                        <a href="public/sdpl-assets/images/our_work/new4.jpg" class="mfp-link" ><img src="public/sdpl-assets/images/our_work/new4.jpg" alt=""></a>
                                    </div>
                                </div>
                                <!-- COLUMNS 2 --> 
                                <div class="item">
                    ...
                    <div class="col-md-5 col-sm-12 bg-white">
                        <aside  class="side-bar">    
                            <div class="index-about3 bg-white" style="text-align: center; margin-top: -15px;">
                                ...
                                <!-- TITLE END -->                            
                                <p>Hotel Royal Orbit is a marvelous combination of Architecture<br> 
                                   and impressive range of hospitality, offering unparalleled <br>
                                   personal service and comfort. The Hotel offers a wide choice <br>
                                   of Banquet Halls and Conference Rooms for Meetings, Product <br>
                                   Launches, Seminars, Birthdays, Anniversaries, Social Get  <br>
                                   Togethers, Exhibitions and Wedding Receptions having areas <br>ranging from 800 sq ft to15,000 sq ft.</p>
                                <div class="col-md-6 col-sm-6 m-tb30">
                        ...
                        <div class="hover-box-effect v-icon-effect">
                            <div class="wt-icon-box-wraper center p-lr30  p-b50 p-t20 bg-gray">
                                ...
                                <div class="icon-content text-black">
                                    ...
                                    <p>Orbit Orbit new residential project Orbit Royale is one of the popular residential developments Located at JabalpurS.</p>
                                    <!--<a href="#" class="site-button-link" data-hover="Read More">Read More</a>-->
                                </div>
                            </div>
