        ...
        <div class="login-box">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url('varify-otp')}}" method="post">
                        @csrf
                        <div class="input-group mb-3">
                            <input type="mobile" name="mobile" class="form-control form-control-sm" placeholder="Enter otp" required>
                            
                        </div>
                        <div class="row">
                            <div class="col-6">
                        <button type="submit" class="btn btn-primary btn-sm">Varify OTP</button>
                            </div>
