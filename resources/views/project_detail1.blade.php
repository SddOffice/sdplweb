@extends('layouts.app')
@section('page_title','project_details1')
                            ...
                            <div class="owl-carousel widget-gallery p-t10 owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="wt-post-thum">
                                        <a href="public/sdpl-assets/images/our_work/new1.jpg" class="mfp-link" ><img src="public/sdpl-assets/images/our_work/new1.jpg" alt=""></a>
                                    </div>
                                </div>
                                <!-- COLUMNS 2 --> 
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="wt-post-thum">
                                        <a href="public/sdpl-assets/images/our_work/arihant-raj-villas-800x533.jpg" class="mfp-link" ><img src="public/sdpl-assets/images/our_work/shawn-elizey-800x533.jpg" alt=""></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-5 col-sm-12 bg-white ">
                        <aside  class="side-bar">    
                            <div class="index-about3 bg-white" style="text-align: center;  margin-top: -15px;">
                                ...
                                <!-- TITLE END -->                            
                                <p>The name Shawn elizey originates from the avenue in <br>
                                   Paris champs- Élysées. It is the ultimate expression <br>
                                   of unhurried luxury. Shawn Elizey with its landscaped gardens,<br>
                                   bespoke service, is the perfect destination for an 
                                   unforgettable wedding. Shawn elizey offers over 20,000 sq ft
                                   of indoor venues besides exotic outdoor settings like three
                                   extensive lawns and poolside garden to choose from.</p>
