@extends('layouts.app')
@section('page_title','project_details2')
                            ...
                            <div class="owl-carousel widget-gallery p-t10 owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="wt-post-thum">
                                        <a href="public/sdpl-assets/images/our_work/new3.jpg" class="mfp-link" ><img src="public/sdpl-assets/images/our_work/new3.jpg" alt=""></a>
                                    </div>
                                </div>
                                <!-- COLUMNS 2 --> 
                                <div class="item">
