  ...
  <!-- Modal -->
    <div class="modal fade main_modal"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createProjectForm">
                    ...
                    <span id="project_url" url="project"></span>
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    {{-- <div class="modal-footer">
                        ...
                        <button type="button" id="editEntranceBtn" class="btn btn-secondary btn-sm ">Next</button>
                    </div> --}}
                    </div>
                {{-- </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="bungalowEntranceForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal" id="bungalowEntrancePreviousBtn">Previous</button>
